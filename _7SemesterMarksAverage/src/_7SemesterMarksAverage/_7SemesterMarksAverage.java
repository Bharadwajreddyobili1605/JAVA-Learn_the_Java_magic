package _7SemesterMarksAverage;

import java.util.Scanner;

public class _7SemesterMarksAverage {
	public static void main(String []args)
	{
		Scanner scan = new Scanner(System.in);
		System.out.println("Enter the 8 semester marks:");
		...
		System.out.println(calculateAverage(sem1,sem2,sem3,sem4,sem5,sem6,sem7,sem8));
